    ...
    if (empty($_GET['periode2'])) {
        ...
        if (empty($_GET['pemasukan'])) {
            ...
            if (empty($_GET['pengeluaran'])) {
                ...
                $pemasukan = explode(',', $_GET['pemasukan']); // Mengubah string menjadi array
                $pengeluaran = explode(',', $_GET['pengeluaran']); // Mengubah string menjadi array
                include '../../_Config/Connection.php';
                include '../../_Config/Session.php';

                // Fungsi untuk membangun klausa LIKE
                ...
                $like_pemasukan = build_like_clause($Conn, 'kode_perkiraan', $pemasukan);
                $like_pengeluaran = build_like_clause($Conn, 'kode_perkiraan', $pengeluaran);
?>
                <html>
                ...
                <body>
                    <table>
                        ...
                        <tr>
                            <td align="center"><?php echo "$periode1 - $periode2"; ?></td>
                        </tr>
                    </table>
                    <table class="data" cellspacing="0">
                        ...
                        while ($DataJurnal = mysqli_fetch_array($QryJurnal)) {
                            ...
                            if (empty($DataJurnal['id_transaksi'])) {
                                ...
                                $LabelTransaksi = "<span class='text-success'>Transaksi $KategoriTransaksi ID.$id_transaksi</span>";
                            }
